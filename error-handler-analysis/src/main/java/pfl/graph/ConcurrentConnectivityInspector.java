 ...
 * @author John V. Sichi
 */
public class ConcurrentConnectivityInspector<V, E>
    implements GraphListener<V, E>
{
     ...
     */
    public ConcurrentConnectivityInspector(Graph<V, E> g)
    {
        init();
    ...
    {
        connectedSets = null;
        vertexToConnectedSet = new ConcurrentHashMap<>();
    }
        ...
        extends TraversalListenerAdapter<V, E>
    {
        ...
        {
            currentConnectedSet = ConcurrentHashMap.newKeySet();
        }
