...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  public static final int     DFS_DATANODE_LAZY_WRITER_INTERVAL_DEFAULT_SEC = 4;
  ...
  public static final int     DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_DEFAULT = 3*1000;
  ...
  public static final int     DFS_NAMENODE_EDIT_LOG_AUTOROLL_CHECK_INTERVAL_MS_DEFAULT = 3*1000;
  ...
  public static final int     DFS_NAMENODE_LAZY_PERSIST_FILE_SCRUB_INTERVAL_SEC_DEFAULT = 3;
  ...
  public static final long DFS_DATANODE_CACHE_REVOCATION_TIMEOUT_MS_DEFAULT = 10000L;
  ...
  public static final long    DFS_NAMENODE_PATH_BASED_CACHE_REFRESH_INTERVAL_MS_DEFAULT = 3000L;
  ...
  public static final long DFS_NAMENODE_STALE_DATANODE_INTERVAL_DEFAULT = 3 * 1000; // 30s
  ...
  public static final int DFS_NAMENODE_STALE_DATANODE_MINIMUM_INTERVAL_DEFAULT = 2; // i.e. min_interval is 3 * heartbeat_interval = 9s
  ...
  public static final long    DFS_NAMENODE_MIN_BLOCK_SIZE_DEFAULT = 0;
  ...
  public static final int     DFS_BALANCER_BLOCK_MOVE_TIMEOUT_DEFAULT = 10000;
  public static final String  DFS_BALANCER_MAX_NO_MOVE_INTERVAL_KEY = "dfs.balancer.max-no-move-interval";
  public static final int     DFS_BALANCER_MAX_NO_MOVE_INTERVAL_DEFAULT = 3*1000; // One minute
  ...
  public static final int    DFS_MOVER_MAX_NO_MOVE_INTERVAL_DEFAULT = 3*1000; // One minute
  ...
  public static final int     DFS_DATANODE_DIRECTORYSCAN_INTERVAL_DEFAULT = 3;
  ...
  public static final long    DFS_NAMENODE_PATH_BASED_CACHE_RETRY_INTERVAL_MS_DEFAULT = 5000L;
  public static final String  DFS_NAMENODE_DECOMMISSION_INTERVAL_KEY = "dfs.namenode.decommission.interval";
  public static final int     DFS_NAMENODE_DECOMMISSION_INTERVAL_DEFAULT = 3;
  ...
  public static final int     DFS_NAMENODE_DECOMMISSION_BLOCKS_PER_INTERVAL_DEFAULT = 3;
  ...
  public static final long    DFS_DATANODE_BP_READY_TIMEOUT_DEFAULT = 5;
  ...
  public static final long    DFS_BLOCKREPORT_INTERVAL_MSEC_DEFAULT = 3000;
  ...
  public static final long    DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS_DEFAULT = 15000L;
  public static final String  DFS_CACHEREPORT_INTERVAL_MSEC_KEY = "dfs.cachereport.intervalMsec";
  public static final long    DFS_CACHEREPORT_INTERVAL_MSEC_DEFAULT = 3 * 1000;
  ...
  public static final int DFS_IMAGE_TRANSFER_TIMEOUT_DEFAULT = 5 * 1000;
  ...
  public static final long DFS_QJM_OPERATIONS_TIMEOUT_DEFAULT = 5000;
  ...
  public static final int     DFS_NAMENODE_RESOURCE_CHECK_INTERVAL_DEFAULT = 3000;
  ...
  public static final int DFS_HA_TAILEDITS_ROLLEDITS_TIMEOUT_DEFAULT = 5; // 1m
  public static final String DFS_HA_LOGROLL_RPC_TIMEOUT_KEY = "dfs.ha.log-roll.rpc.timeout";
  public static final int DFS_HA_LOGROLL_RPC_TIMEOUT_DEFAULT = 5000; // 20s
  ...
  public static final int DFS_HA_ZKFC_NN_HTTP_TIMEOUT_KEY_DEFAULT = 5000;
  ...
  public static final long   DFS_DATANODE_XCEIVER_STOP_TIMEOUT_MILLIS_DEFAULT = 5000;
