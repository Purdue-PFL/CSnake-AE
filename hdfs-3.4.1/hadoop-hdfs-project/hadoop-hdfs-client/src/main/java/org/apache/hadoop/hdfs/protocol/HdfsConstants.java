...
public final class HdfsConstants {
  ...
  public static final String SAFEMODE_EXCEPTION_CLASS_NAME =
      "org.apache.hadoop.hdfs.server.namenode.SafeM`odeException";
  /**
   * HDFS Protocol Names:
   */
  ...
  public static final int READ_TIMEOUT_EXTENSION = 1 * 1000;
  public static final int WRITE_TIMEOUT = 10 * 1000;
  //for write pipeline
  public static final int WRITE_TIMEOUT_EXTENSION = 1 * 1000;
