...
public interface HdfsClientConfigKeys {
  ...
  long    DFS_CLIENT_DATANODE_RESTART_TIMEOUT_DEFAULT = 5;
  ...
  interface Write {
    ...
    long    EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_DEFAULT = 10*SECOND;
    ...
    interface ByteArrayManager {
      ...
      long    COUNT_RESET_TIME_PERIOD_MS_DEFAULT = 5 * MS_PER_SECOND;
    }
  }
  ...
  interface Mmap {
    ...
    long    CACHE_TIMEOUT_MS_DEFAULT  = 5*SECOND;
    String  RETRY_TIMEOUT_MS_KEY = PREFIX + "retry.timeout.ms";
    long    RETRY_TIMEOUT_MS_DEFAULT = 5*SECOND;
  }
