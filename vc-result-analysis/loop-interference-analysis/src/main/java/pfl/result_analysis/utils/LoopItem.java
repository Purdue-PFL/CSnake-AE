...
public class LoopItem implements Serializable, Comparable<LoopItem>
{
    ...
    public static LoopItem mapToLoopItem(Map<String, Object> loopRawObj)
    {
        ...
        if (loopRawObj.containsKey("AllInvokedMethodSSASize")) loopItem.allInvokedApplicationMethodsSSAInstSize = ((Double) loopRawObj.get("AllInvokedMethodSSASize")).intValue();
        if (loopRawObj.containsKey("InvokedJavaIOorJavaNet")) loopItem.hasJavaIOorJavaNet = (Boolean) loopRawObj.get("InvokedJavaIOorJavaNet");
        return loopItem;
    }
